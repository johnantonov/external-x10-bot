...
export const texts = {
  ...
  addSku: newSku,
  addedNewKey: '✅ Вы добавили верный WB ключ\n\nВ первую очередь необходимо внести список SKU для отслеживания:',
  ...
  faq_2: `Расшифровка показателей в отчете\n\nКлики АРК - общее количество кликов в автоматической рекламной кампании\nCTR АРК - конверсия из показа в клик в автоматической рекламной кампании\n\nКлики ПРК - общее количество кликов в поисковой рекламной кампании (аукцион)\nCTR ПРК - конверсия из показа в клик в поисковой рекламной кампании (аукцион)\n\nКорз. - общее количество корзин за день, в шт.\nЗаказы - сумма и количество фактических заказов за день\nВыкупы - сумма и количество фактических выкупов за день\n\nРасходы реклама - общие расходы по РК в АРК и ПРК\nДРР - доля рекламных расходов, считается от заказов\n\nМаржа - отношение прибыли товара к его цене до СПП\nПрибыль до ДРР - расчетная прибыль на основе заказов и среднего процента выкупа за день\nПрибыль с ДРР - расчетная прибыль с учётом расходов на рекламу за день\nКРРР - коэффициент рентабельности рекламных расходов. Он показывает, какая доля прибыли остаётся после вычета рекламных расходов относительно общей прибыли`,
