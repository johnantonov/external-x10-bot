...
export const texts = {
  start: `<b>Телеграм бот от Команды 10X</b>\n\nПолучайте ежедневные отчеты ключевым показателям ваших товаров.\n\nПоказывает ежедневно:\n\n▫️Заказы, Выкупы, Возвраты по любому дню\n▫️Расчетная прибыль по товарам, в динамике за 5 дней. Видны ошибки в работе с товаром\n▫️PDF отчет по кликам, CTR, корзинам\n▫️Расходы на рекламу, ДРР, КРРР\n▫️Остатки: прибыль на сумму остатков, количество\n▫️Ежедневные отчеты по часам\n\nДля начала работы необходимо подключить бота к вашему кабинету👇`,
  menu: " ", 
  ...
  getOrdersReportText: `Введите дату, за которую хотите получить отчет.\nПодойдет любой из следующих форматов:\n\n19/11/2024\n19.11.2024`,
