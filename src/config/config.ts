...
export const config = {
  ...
  pdf: {
    ...
    titleFz: 44,
    footerText: `Отчёт подготовлен ботом <a href="https://t.me/X10XTestBot">@bot_123</a> от команды 10X.<br><br>Получите подробный отчет по всем SKU вашего кабинета.<br>                              ⬇️<br><b>Бесплатный доступ на 3 дня:</b> <a href="https://t.me/tenXsupport_bot">@tenXsupport_bot</a>`,
