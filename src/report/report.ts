...
// import { getWbArticlePhoto, parsePercent } from "../utils/parse";
// import { formatNumber, NumberOrZero } from "../utils/string";
// import { create31DaysObject, getYesterdayDate } from "../utils/time";
...
//         imgBuffer = await sharp(imgBuffer).resize({ width: 90, height: 120 }).toBuffer();
